...
setTimeout(() => {
  ...
  const checks = {
    ...
    "Seerr tile host rendered":          inner.includes("seerr.zerotwosystems.com"),
    "Plex tile removed":                 !inner.toLowerCase().includes("plex"),
    "Porttracker tile removed":          !inner.toLowerCase().includes("porttracker"),
    ...
    "service tiles >= 7":                doc.querySelectorAll(".tile").length >= 7,
